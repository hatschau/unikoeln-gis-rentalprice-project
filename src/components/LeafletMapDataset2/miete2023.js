...
function pop_MieteWB_2023_4(feature, layer) {
...
function style_MieteWB_2023_4_0(feature) {
    if (feature.properties['Miete_2023'] >= 0.000000 && feature.properties['Miete_2023'] <= 2.500000) {
        return {
    ...
    if (feature.properties['Miete_2023'] >= 2.500000 && feature.properties['Miete_2023'] <= 5.000000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 5.000000 && feature.properties['Miete_2023'] <= 7.500000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 7.500000 && feature.properties['Miete_2023'] <= 10.000000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 10.000000 && feature.properties['Miete_2023'] <= 12.500000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 12.500000 && feature.properties['Miete_2023'] <= 15.000000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 15.000000 && feature.properties['Miete_2023'] <= 17.500000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2023'] >= 17.500000 && feature.properties['Miete_2023'] <= 20.100000) {
        return {
            pane: 'pane_MieteWB_2023_4',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
...
export { pop_MieteWB_2023_4, style_MieteWB_2023_4_0 }