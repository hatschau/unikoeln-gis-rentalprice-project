...
function pop_MieteWB_2019_3(feature, layer) {
...
function style_MieteWB_2019_3_0(feature) {
    if (feature.properties['Miete_2019'] >= 0.000000 && feature.properties['Miete_2019'] <= 2.500000) {
        return {
    ...
    if (feature.properties['Miete_2019'] >= 2.500000 && feature.properties['Miete_2019'] <= 5.000000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 5.000000 && feature.properties['Miete_2019'] <= 7.500000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 7.500000 && feature.properties['Miete_2019'] <= 10.000000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 10.000000 && feature.properties['Miete_2019'] <= 12.500000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 12.500000 && feature.properties['Miete_2019'] <= 15.000000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 15.000000 && feature.properties['Miete_2019'] <= 17.500000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
    ...
    if (feature.properties['Miete_2019'] >= 17.500000 && feature.properties['Miete_2019'] <= 20.100000) {
        return {
            pane: 'pane_MieteWB_2019_3',
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
...
export { pop_MieteWB_2019_3, style_MieteWB_2019_3_0 }